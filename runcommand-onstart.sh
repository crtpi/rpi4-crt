...
# view tvservice status
echo 'runcommand-onstart' > /opt/retropie/configs/all/desired_mode/value
...
#		vcgencmd hdmi_timings 2048 1 180 202 300 240 1 3 5 14 0 0 0 60 0 42954545 1 > /dev/null #Retrotink 2048x240p Timing Original
		echo 'vcgencmd hdmi_timings 2048 1 160 202 320 240 1 3 5 14 0 0 0 60 0 42954545 1 && tvservice -c "DMT 87" && fbset -depth 8 && fbset -depth 16 && fbset -depth 24 && fbset -depth 32 -xres 2048 -yres 240' > /opt/retropie/configs/all/desired_mode/value 
		...
		ffbset -depth 16 && fbset -depth 24 && fbset -depth 32 -xres 2048 -yres 240 > /dev/null #VGA666 16b depth
...
#		vcgencmd hdmi_timings 1920 1 52 208 260 240 1 6 10 6 0 0 0 60 0 38400000 1 > /dev/null #Pi2SCART PCE/PCE-CD 1920x240p Timing
		echo 'vcgencmd hdmi_timings 1920 1 137 247 295 240 1 3 7 12 0 0 0 60 0 40860000 1 && tvservice -c "DMT 87" && fbset -depth 16 && fbset -depth 24 && fbset -depth 32 -xres 1920 -yres 240' > /opt/retropie/configs/all/desired_mode/value
		...
		tvservice -c "DMT 87" > /dev/null
		fbset -depth 16 && fbset -depth 24 && fbset -depth 32 -xres 1920 -yres 240 > /dev/null #VGA666 16b depth
	# change timings for 256x systems to 2048x240p
		...
		[[ "$system" == "sg-1000" ]] ; then
#			vcgencmd hdmi_timings 2048 1 180 202 300 240 1 3 5 14 0 0 0 60 0 42954545 1 > /dev/null #Retrotink 2048x240p Timing Original
			echo 'vcgencmd hdmi_timings 2048 1 160 202 320 240 1 3 5 14 0 0 0 60 0 42954545 1 && tvservice -c "DMT 87" && fbset -depth 16 && fbset -depth 24 && fbset -depth 32 -xres 2048 -yres 240' > /opt/retropie/configs/all/desired_mode/value 
			vcgencmd hdmi_timings 2048 1 160 202 320 240 1 3 5 14 0 0 0 60 0 42954545 1 > /dev/null #Retrotink 2048x240p Timing Adjusted
			tvservice -c "DMT 87" > /dev/null
			fbset -depth 16 && fbset -depth 24 && fbset -depth 32 -xres 2048 -yres 240 > /dev/null #VGA666 16b depth
...
#		vcgencmd hdmi_timings 1600 1 85 157 192 240 1 4 3 15 0 0 0 60 0 32000000 1 > /dev/null #VGA666 Standard 1600x240p Timing Original
		echo 'vcgencmd hdmi_timings 1600 1 73 157 204 240 1 4 3 15 0 0 0 60 0 32000000 1 && tvservice -c "DMT 87" && fbset -depth 16 && fbset -depth 24 && fbset -depth 32 -xres 1600 -yres 240' > /opt/retropie/configs/all/desired_mode/value
		...
		tvservice -c "DMT 87" > /dev/null
		ffbset -depth 16 && fbset -depth 24 && fbset -depth 32 -xres 1600 -yres 240 > /dev/null #VGA666 16b depth
	fi

else
# for non-libretro emulators switch to 320x240p
	echo 'vcgencmd hdmi_timings 320 1 16 30 34 240 1 2 3 22 0 0 0 60 0 6400000 1 && tvservice -c "DMT 87" && fbset -depth 16 && fbset -depth 24 && fbset -depth 32 -xres 320 -yres 240' > /opt/retropie/configs/all/desired_mode/value
	vcgencmd hdmi_timings 320 1 16 30 34 240 1 2 3 22 0 0 0 60 0 6400000 1 > /dev/null #VGA666 320x240p Timing
	tvservice -c "DMT 87" 
	fbset -depth 16 && fbset -depth 24 && fbset -depth 32 -xres 320 -yres 240 > /dev/null #VGA666 16b depth
fi
